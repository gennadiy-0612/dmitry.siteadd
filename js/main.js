...
shch.Slider = function (selectorSlide, activeForward, activeBack, setSons) {
    ...
    this.Plus = function () {
        this.one < this.Item.length ? this.one++ : this.one = 0;
        this.two < this.Item.length ? this.two++ : this.two = 0;
        this.three < this.Item.length ? this.three++ : this.three = 0;
        this.four < this.Item.length ? this.four++ : this.four = 0;
        this.five < this.Item.length ? this.five++ : this.five = 0;
